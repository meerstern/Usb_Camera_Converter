...
const uint8_t INIT_ST7735B[] = {
  ...
  3,   0, FRMCTR1,0x01,0x2C,0x2D,//ADD
  
  3,   0, FRMCTR2,0x01,0x2C,0x2D,//ADD
  
  6,   0, FRMCTR3,0x01,0x2C,0x2D,0x01,0x2C,0x2D,//ADD
  
  2,   0, DISSET5,0x15,0x02,//ADD
  
 16,   0, GMCTRP1,0x02, 0x1c, 0x07, 0x12, 0x37, 0x32, 0x29, 0x2d, 0x29, 0x25, 0x2B, 0x39, 0x00, 0x01, 0x03, 0x10,
 16,   0, GMCTRN1,0x03, 0x1d, 0x07, 0x06, 0x2E, 0x2C, 0x29, 0x2D, 0x2E, 0x2E, 0x37, 0x3F, 0x00, 0x00, 0x02, 0x10,
...
uint8_t ST7735_SetWindow (struct st7735 * lcd, uint8_t x0, uint8_t x1, uint8_t y0, uint8_t y1)
{
  ...
  //SYS_DEBUG_PRINT(SYS_ERROR_WARNING, "X:0x%LX,Y:0x%LX\r\n",x1,y1); 
