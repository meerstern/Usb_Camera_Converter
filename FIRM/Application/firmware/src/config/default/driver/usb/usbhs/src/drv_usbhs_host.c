...
//                    if(flag==false)
//                    {
//                        SYS_DEBUG_PRINT(SYS_ERROR_WARNING,"Power Voltage is NOT Sufficient\r\n"); 
//                        flag=true;
//                    }
//                }
            }
...
)
{
    ...
    else
    {
        if(((DRV_USBHS_CLIENT_OBJ *)handle)->inUse)
        {
            ...
            //SYS_DEBUG_PRINT(SYS_ERROR_INFO, "PLIB_USBHS_VBUSLevelGet:%X\r\n",PLIB_USBHS_VBUSLevelGet(usbID));
